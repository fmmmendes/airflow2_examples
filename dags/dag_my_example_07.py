...
with DAG(
    ...
    # https://airflow.apache.org/docs/apache-airflow/2.4.0/_api/airflow/operators/trigger_dagrun/index.html
    call_dag = TriggerDagRunOperator(
        task_id = 'call_dag',
